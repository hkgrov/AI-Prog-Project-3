...
class BasicClientActor(BasicClientActorAbs):
    ...
    def handle_get_action(self, state):
        ...
        grid2 = self.statemanager.to_network_board2(list(grid), player)
    ...
    #    print(player)
     #   print(grid2)
        ...
        action = self.anet.predict(grid2, grid)
        next_move = self.statemanager.to_multi(action)
    ...
    def handle_series_start(self, unique_id, series_id, player_map, num_games, game_params):
        ...
        self.statemanager = hex2.Stateman(game_params[0]) 
        self.anet = hex2.Anet(self.statemanager)
        
        #Change this to the model I should use!!!!
        self.anet.load_model("models/vise_frem/model_1000.h5")
        #############################
        #
        #
